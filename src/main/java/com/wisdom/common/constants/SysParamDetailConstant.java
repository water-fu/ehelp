...
public class SysParamDetailConstant {
    ...
    public static final String ACCOUNT_TYPE_ADMIN = "4"; // 管理员
    ...
    public static final String ACCOUNT_STATUS_AUTHEN = "2"; // 已认证

    public static final String ACCOUNT_STATUS_INVALID = "0"; // 失效
